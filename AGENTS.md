...
- For AppKit display or notification observers owned by a `@MainActor` object, prefer selector-based `NotificationCenter` observation over storing closure observer tokens.
